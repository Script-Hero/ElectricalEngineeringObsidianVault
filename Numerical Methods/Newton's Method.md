A type of [[Fixed Point Iteration]] [[Electronics/Electronics/Root|Root]] finding algorithm. 
$$
...
2. The initial guess $x_0$ is sufficiently close to the [[Electronics/Electronics/Root|Root]] $x^*$
3. $f'(x^*)\neq0$
