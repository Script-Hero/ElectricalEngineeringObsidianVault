A square [[Electronics/Electronics/Root|Root]] approximation algorithm in quadratic time. 
$$
x_{n+1}=x_n-\frac{1}{2}\frac{x_n^2-S}{x_n}
$$
- Where $S$ is the value we want the square [[Electronics/Electronics/Root|Root]] of and $x_n$ starts off as an initial guess and is updated iteratively
