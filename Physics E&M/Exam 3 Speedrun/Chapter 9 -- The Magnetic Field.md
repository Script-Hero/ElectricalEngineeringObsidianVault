...
- magnetic force increases with the charge of the particle you're sending in and $|\vec{v}|\sin\theta$
...
In a $\vec{B}$ field a charged particle moves in a circle if $\vec{v}$ and $\vec{B}$ are *perfectly perpendicular* and otherwise are in a helix
- If it's in a circle then $r=\frac{mv}{qB}$
