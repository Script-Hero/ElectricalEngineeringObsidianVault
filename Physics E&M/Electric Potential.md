- SI unit = Volt, $1 V = 1\frac{J}{C}$
Work = how a force affects the motion of an object over a distance
$W_{tot}=\Delta{K}$
$\int\vec{F}=-\frac{\delta u}{\delta x}$

Mechanical energy = Kinetic Energy + Potential energy
	- Kinetic energy = $\frac{1}{2}ma^{2}$

---

## We find the work done on a charge by using Coulomb's Law
