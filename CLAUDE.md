...
- Notes use Obsidian's wiki-link format `[[Topic Name]]` for cross-references
- Images and diagrams are embedded using standard Markdown or stored as PNG files
...
- When adding new notes, follow the existing naming conventions and link structures
- Mathematical content should use proper LaTeX formatting
- Maintain the course-based folder organization
- Cross-link related concepts between courses when appropriate
- Preserve the academic integrity and educational purpose of all content

This vault represents active coursework and study materials, not a software development project.