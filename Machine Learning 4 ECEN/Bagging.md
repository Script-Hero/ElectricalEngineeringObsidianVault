***B**ootstrap **agg**regat**ing*** or bagging is a general-purpose procedure for **reducing the variance of a statistical learning method.**

Consider a set of $n$ independent observations $x_1,x_2,\dots,x_n$ with mean $\mu$ and variance $\sigma^2$
