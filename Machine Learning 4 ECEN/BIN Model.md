...
- **No.** It is *possible* for the sample to be all green marbles and the bin to be mostly red

**Then why do we trust polling (i.e. using a sample to try to predict the global result)?**
- Because the bad case is *possible* but not *probable*.
