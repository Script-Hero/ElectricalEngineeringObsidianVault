An [[Operational Amplifier]] configuration that produces an output which is a linear combination (with opposite signs, meaning one is being subtracted from the other) of two input signals.

![[difference_amplifier.png]]

$$v_o=\frac{(R_f+R_a)R_g}{(R_g+R_b)R_a}v_b-\frac{R_f}{R_a}v_a$$

Derived from [[Operational Amplifier]] characteristics:
