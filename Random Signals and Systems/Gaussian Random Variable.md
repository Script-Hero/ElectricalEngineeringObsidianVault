...
**If a Gaussian Random Variable has $\mu=0$ and $\sigma^2=1$ it is a *standard normal random variable*.**


### Characteristics
- [[Expected Value]] $E[X]=\mu$
- [[Variance]] $Var[X]=\sigma^2$
- The [[Cumulative Distribution Function]] of a Gaussian Random Variable has no closed-form solution, instead it is expressed with $\Phi(\frac{x-m}{\sigma})$
